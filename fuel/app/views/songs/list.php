...
<table class="table table-striped table-borderd">
	...
	<?php foreach ($songs as $song): ?>
		<tr>
			...
			<td><a href="<?php echo Uri::create('songs/edit/' . $song->id); ?>" class="btn btn-primary" style="width:28px">編集</a></td>
			<td><a href="<?php echo Uri::create('songs/delete/' . $song->id); ?>" onclick="return confirm('本当に削除しますか？')" class="btn btn-danger" style="width:28px">削除</a></td>
		</tr>
	<?php endforeach; ?>
</table>